...
If you wish to use the latest version, you can use `$..[?(@.LATEST)]` instead of `$['<version>']` in the expressions (note that this JSONPath is weird due to [JamesNK/Newtonsoft.Json#2311](https://github.com/JamesNK/Newtonsoft.Json/issues/2311)).
